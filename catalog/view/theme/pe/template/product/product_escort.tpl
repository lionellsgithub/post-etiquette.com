...
<div id="productcollectionscontent"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      <?php if ($thumb) { ?>
      <div class="image"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="fancybox" rel="fancybox"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a>
      <?php if ($images) { ?>
  ...
  <?php if ($products) { ?>
    ...
    <p>same basket, different egg</p>
      <?php foreach ($products as $product) { ?>
      <div>
        <?php if ($product['thumb']) { ?>
        <div class="image2"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a>
  ...
  <div class="cart">
      <p> REST EASY. </BR> BEFORE WE START ANYTHING WE WILL EMAIL YOU TO CONFIRM THE INFO YOU FILLED OUT. </p>
    ...
    <!--
      ...
      <div class="options">
       <!-- <h2><?php echo $text_option; ?></h2> -->
        <br />
        <p>Got your own custom table names?  no probs, just enter in your table names followed by the # of guests per table.  (example: table name, 8)  additional cost of 30 cents per card.</p>
