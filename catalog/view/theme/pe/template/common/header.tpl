...
<?php } ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/pe/stylesheet/stylesheet.css" />
...
<?php } ?>
<!--[if IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/pe/stylesheet/ie7.css" />
<![endif]-->
<!--[if lt IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/pe/stylesheet/ie6.css" />
...
<div id="header">
  <?php if ($logo) { ?>
  <div id="logo"><a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></div></a>
  <?php } ?>
 ...
 <!-- <a href="<?php echo $wishlist; ?>" id="wishlist_total"><?php echo $text_wishlist; ?></a> -->
  <a href="<?php echo $account; ?>">LOGIN</a>
  <a href="<?php echo $cart; ?>">MY STASH</a>
  <a href="<?php echo $checkout; ?>">CHECKIN OUT</a>
  </div>
</div>

<div id="menu">
  <ul>
  <li><a href="http://post-etiquette.com/index.php?route=information/information&information_id=4">INFO</a></li>
  <!--  <li><a href="http://post-etiquette.com/index.php?route=product/category&path=20">COLLECTIONS</a> -->
      <li><a href="http://post-etiquette.com/index.php?route=product/category&path=57">BRANDING</a></li>
    <li><a href="http://www.post-etiquette.com/index.php?route=common/showcase#1">CUSTOM</a>
        <li><a href="http://post-etiquette.com/index.php?route=product/category&path=75">FAQ</a>
    <li><a href="http://post-etiquette.tumblr.com" target="_blank">BLOG</a>
  </ul>
</div>
